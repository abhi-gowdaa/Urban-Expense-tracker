...
// let expenseContent=<p> no item yet </p>

// if(filteredExpenses.length>0){
//   expenseContent=filteredExpenses.map((expense)=>  //props.items.map to scarp all  //array loop instead of for loop,jsx built in
